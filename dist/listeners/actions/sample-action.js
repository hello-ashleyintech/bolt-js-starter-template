...
var _this = this;
var sampleActionCallback = function (_a) {
    var ack = _a.ack, client = _a.client, body = _a.body;
    return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.sent();
                    return [4 /*yield*/, client.views.update({
...
module.exports = { sampleActionCallback: sampleActionCallback };
