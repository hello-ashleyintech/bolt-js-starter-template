...
const DefineFunction = (definition) => new SlackFunction(definition);
class SlackFunction {
  id;
...
const CreateUntypedObjectParameterVariable = (namespace, paramName) => WithUntypedObjectProxy({}, namespace, paramName);
const CreateSingleParameterVariable = (namespace, paramName) => ParamReference(namespace, paramName);
...
const DefineWorkflow = (definition) => new WorkflowDefinition(definition);
...
const DefineType = (definition) => new CustomType(definition);
class CustomType {
  id;
...
const DefineDatastore = (definition) => new SlackDatastore(definition);
...
export { DefineType };
export { Schema };
export { DefineDatastore };
export { SlackFunctionTester };
